...
var strat = {
	...
	resetTrend: function()
	{
		...
		this.trend = trend;
        // log.info('Reset Trend:', this.trend);
	},
	...
	check: function()
	{
		...
		if( maFast < maSlow )
		{
            ...
            if (this.trend.previousAdvice == 'short') {
                if (rsi < rsi_hi) this.short();
            } else if (this.trend.previousAdvice == 'long') {
                if (rsi > rsi_low) this.long()
            }
                if (rsi > rsi_hi) this.trend.previousAdvice = 'short';
                else if (rsi < rsi_low) this.trend.previousAdvice = 'long';



			
			if(this.debug) this.lowHigh( rsi, 'bear' );
            // log.info('End Check Bear Trend:', this.trend);
		}
		...
		else
		{
            ...
            // log.info('End Check Bull Trend:', this.trend);
