...
def getSettings(specific=None):
    ...
    s = {
        'Global': {
            ...
            'GekkoURLs': ['http://localhost:3000','http://18.219.12.229:3000','http://18.221.183.250:3000'],
        ...
        'generations': {
            ...
            'showIndividualEvaluationInfo': True,
            ...
            'evaluateSettingsPeriodically': False,
